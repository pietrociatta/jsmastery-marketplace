  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flex-center sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
        <div
          className="relative w-557 minmd:w-2/3 minmd:h-2/3 sm:w-full sm:h-300 h-557"
          h-557
        >
          <Image
            src={nft.image}
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-black-1 border-nft-gray-1 flex flex-row">
            <p className="font-poppins dark:text-white text-nft-black-1 font-medium text-base minlg:text-base mb-2">
              Details
            </p>
          </div>
          <div className="mt-3 ">
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase() ? (
            ...
            <Button
              ...
              classStyles="rounded-xl mr-5 sm:mr-0"
              handleClick={() =>
                router.push(
        ...
        <Modal
          ...
          body={
            ...
            >
              ...
              <p className="font-poppins dark:text-white text-nft-black-1 text-sm minlg:text-xl mt-10 font-normal">
